...
const Input = {
    Norm: {
        ...
        shadowDP: IO(() => Pair(λ.ctx.shadowOffsetX / λ.ctx.canvas.width, λ.ctx.shadowOffsetY / λ.ctx.canvas.height)),
        shadowDV: IO(() => Vector2(λ.ctx.shadowOffsetX / λ.ctx.canvas.width, λ.ctx.shadowOffsetY / λ.ctx.canvas.height)),
